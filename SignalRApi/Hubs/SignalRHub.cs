...
namespace SignalRApi.Hubs
{
    public class SignalRHub : Hub
    {
        ...
        public SignalRHub(IBookingService bookingService ,ICategoryService categoryService, IProductService productService, IOrderService orderService, IMoneyCaseService moneyCaseService, IMenuTableService menuTableService, INotificationService notificationService)
        {
        ...
        {
            await Clients.All.SendAsync("ReceiveMessage", user, message); // anlık mesajlaşma
        }
