...
using SignalWebUI.Dtos.ProductDtos;
using System.Text;
...
namespace SignalWebUI.Controllers
{
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> CreateProduct(CreateProductDto createProductDto)
        {
            ...
            var client = _httpClientFactory.CreateClient();
            var jsonData = JsonConvert.SerializeObject(createProductDto); // ekleme de serialize
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"https://localhost:7071/api/Product/{id}");
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
        ...
        public async Task<IActionResult> UpdateProduct(int id)
        {
            ...
            var responseMessage1 = await client1.GetAsync("https://localhost:7071/api/Category");
        ...
        public async Task<IActionResult> UpdateProduct(UpdateProductDto updateProductDto)
        {
            ...
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            var responseMessage = await client.PutAsync("https://localhost:7071/api/Product/", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
