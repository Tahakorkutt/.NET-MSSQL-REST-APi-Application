...
namespace SignalWebUI.Controllers
{
	public class DiscountController : Controller
	{
			...
			{
				var client = _httpClientFactory.CreateClient();
				await client.GetAsync($"https://localhost:7071/api/Discount/ChangeStatusToTrue/{id}");
				return RedirectToAction("Index");
			}
			...
			{
				var client = _httpClientFactory.CreateClient();
				await client.GetAsync($"https://localhost:7071/api/Discount/ChangeStatusToFalse/{id}");
				return RedirectToAction("Index");
			}
		}
	}
